"""
Django settings for Terjuman.live backend.
"""
...
# Render preview/custom domains share the same deployment.
for default_host in (".onrender.com",):
